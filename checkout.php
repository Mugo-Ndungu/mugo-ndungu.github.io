  ...
  <body>
    ...
    <div class="">
      ...
      <div class="overflow-visible">
          ...
          <div class="container">
            <div class="row g-6 g-xxl-12">
              <div class="col-lg-6 order-2">
                <form class="d-flex flex-column gap-4 gap-md-8">
                  ...
                  <div class="brn4 p-3 p-md-5 rounded">
                    ...
                    <div class="d-flex align-items-center gap-2">
                      <input
                        type="checkbox"
                        id="check"
                        class="cursor-pointer fs-six"
                      />
                      <label
                        for="check"
                        class="n4-color fs-eight cursor-pointer"
                  ...
                  <div class="brn4 p-3 p-md-5 rounded">
                    ...
                    <div
                      class="radioBtn d-flex gap-2 align-items-center brn4 px-2 px-md-3 rounded w-100 mb-2 mb-md-3"
                    >
                      <input
                        type="radio"
                        required
                        class="brn4 p-3 n5-color my-2 my-md-3 w-max"
                        id="radio1"
                        name="radio"
                      />
                      <label
                        for="radio1"
                        class="cursor-pointer n5-color d-flex justify-content-between align-items-center py-1 py-md-2 w-100"
                        >Inside Dhaka City
                    ...
                    <div class="d-flex flex-column gap-2 gap-md-3">
                      <div class="radio-wrapper position-relative">
                        ...
                        >
                          ...
                          <label
                            for="py1"
                            class="cursor-pointer n5-color py-1 py-md-2 w-100"
                      ...
                      <div class="radio-wrapper position-relative">
                        ...
                        <div class="radio-content p-2 rounded">
                          <span class="n5-color d-block"
                            >Pay with your bkash wallet</span
                          >
                          <span class="n5-color d-block"
                            >4004911111 - Merchant Account (Make Payment)</span
                          >
                          <span class="n5-color d-block"
                            >Put your order ID as reference number</span
                          >
                        </div>
                      </div>
                      <div class="radio-wrapper position-relative">
                        ...
                        <div class="radio-content p-2 rounded">
                          <span class="n5-color d-block"
                            >You can transfer the invoice amount to following
                            Bank Account :</span
                          >
                          <span class="n5-color d-block"
                            >Bank Name: City Bank Bangladesh</span
                          >
                          <span class="n5-color d-block"
                            >Account Name: GRID Ventures Ltd</span
                          >
                          <span class="n5-color d-block"
                            >Account Number: 1003615365001</span
                          >
                          <span class="n5-color d-block"
                            >Branch Name: Banani Branch</span
                          >
                          <span class="n5-color d-block"
                            >Please call us at 014044-330 to confirm the payment
                      ...
                      <div class="radio-wrapper position-relative">
                        ...
                        <div class="radio-content p-2 rounded">
                          <span class="n5-color d-block"
                            >EMI available for following bank credit card:</span
                          >
                          <span class="n5-color d-block"
                            >Eastern Bank Limited</span
                          >
                          <span class="n5-color d-block"
                            >LankaBangla Finance Limited</span
                          >
                          <span class="n5-color d-block"
                            >United Commercial Bank</span
                          >
                          <span class="n5-color d-block"
                            >Dutch Bangla Bank Ltd.</span
                          >
              ...
              <div class="col-lg-6 order-1 order-lg-2">
                <div
                  class="bgn2-color p-3 p-sm-6 p-md-10 h-100 br-left-n4 rounded"
                >
                  <div class="checkout-right brn4 p-3 p-md-5 rounded">
                    <div class="d-flex align-items-start gap-4 mb-3 mb-md-5">
                      ...
                      />
                      <div
                        class="d-flex flex-wrap gap-2 align-items-center justify-content-between w-100"
                      >
                        <div>
                          ...
                          <div class="d-flex gap-1 align-items-center">
                            <span
                              class="discrement fs-eight n5-color cursor-pointer"
                            >
                              <i class="ph-bold ph-minus"></i>
                            </span>
                            <span
                              class="product-count fs-eight fw-semibold n5-color py-1 px-2 brn4 rounded"
                              >1</span
                            >
                            <span
                              class="increment fs-eight n5-color cursor-pointer"
                            >
                              <i class="ph-bold ph-plus"></i>
                            </span>
                          </div>
                        </div>
                        <span class="fs-eight p1-color d-block"
                          >$120.00 USD</span
                        >
                      </div>
                    </div>
                    ...
                    <div class="mt-3 mt-md-6">
                      <span
                        class="d-flex align-items-center gap-2 justify-content-between mb-1"
                      >
        ...
        <section
          class="container d-flex flex-wrap gap-3 gap-md-6 justify-content-center justify-content-sm-between align-items-center pb-4 pb-md-8 text-center"
        >
