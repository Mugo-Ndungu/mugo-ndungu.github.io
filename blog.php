              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    Top Data Analysis Tools for Beginners in 2024
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                    Mastering SQL: Essential Tips for Data Analysts
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                    The Ultimate Guide to Data Visualization with Tableau
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                    How to Use Power BI for Effective Data Analysis
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                    Trends in Data Analysis: What to Expect in 2024
                    </h4>
                  </div>
                </a>
              </div>
              ...
              >
                <a href="blog_details.php" class="blog-card">
                  ...
                  <div class="pt-4 pt-md-8 px-3 px-md-5">
                    ...
                    <h4 class="blog-title fs-five n5-color fw-semibold">
                    Building a Career in Data Analysis: Tips and Strategies
                    </h4>
                  </div>
                </a>
              </div>
