          ...
          <div
            ...
            <div class="banner-content">
              ...
              <p class="fs-seven n5-color">
                I'm a data analyst specializing in transforming raw data into actionable insights. Explore my <a href="blog.php" class="p1-color"> blog </a>,<a
                  href="portfolio.php"
                  class="p1-color">
                  project portfolio</a>
                and <a href="resume.php" class="p1-color">online resume</a> to see how I can help your organization make data-driven decisions.
          ...
          <div
            ...
            <div data-aos="zoom-in-left" class="section-heading">
              ...
              <p class="fs-seven n4-color mt-2 mt-md-4">
                I have more than 5 years of experience in data analysis, working with clients all over the world. Below is a quick overview of my main technical skill sets and technologies I use. Want to find out more about my experience? Check out my
            ...
            <div
              ...
              <div class="service-card px-4 px-lg-8 py-5 py-lg-10">
                ...
                <p class="fs-seven n4-color">
                  Proficient in libraries such as Pandas, NumPy, Matplotlib for manipulation and visualization.
                </p>
              </div>
            </div>
            <div
              ...
              <div class="service-card px-4 px-lg-8 py-5 py-lg-10">
                ...
                <p class="fs-seven n4-color">
                  Expertise in creating interactive dashboards and visualizations.
                </p>
              </div>
            </div>
            <div
          ...
          <div class="row g-6 g-md-8">
            <div data-aos="fade-up" data-aos-duration="800" class="col-xl-6">
              <div class="project-card">
                <a href="portfolio_details.php" class="thumb d-block">
                  ...
                  <div>
                    <div class="d-flex flex-wrap gap-2 align-items-center">
                      <a
                        ...
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">Python</a>
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">Pandas</a>
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">Matplotlib</a>
                    </div>
                    <a
                      href="portfolio_details.php"
                ...
                <div
                  ...
                  <div>
                    <div class="d-flex gap-2 align-items-center">
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">R</a>
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">ggplot2</a>
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">dplyr</a>
                    </div>
                    <a
                      href="portfolio_details.php"
                      class="project-title fs-five fw-semibold n5-color mt-3 mt-md-5 d-block">
                ...
                <div
                  ...
                  <div>
                    <div class="d-flex gap-2 align-items-center">
                      ...
                      <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">Scikit-Learn</a>
                      <!-- <a
                        href="javascript:void(0)"
                        class="n5-color fs-nine px-2 px-md-4 py-1 py-md-2 brn3 rounded-pill fw-medium">Web Development</a> -->
                    </div>
                    <a
                      href="portfolio_details.php"
                      class="project-title fs-five fw-semibold n5-color mt-3 mt-md-5 d-block">
          ...
          <div class="mt-8 mt-md-15 overflow-x-hidden">
            <div class="swiper testimonial_slider">
              ...
              <div class="relative mt-15">
                <div
                  class="swiper-pagination d-flex allign-items-center justify-content-center gap-2"></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          ...
          <div class="row g-6">
            <div
              ...
              <a href="blog_details.php" class="blog-card">
                ...
                <div class="pt-4 pt-md-8 px-3 px-md-5">
                  ...
                  <h4 class="blog-title fs-five n5-color fw-semibold">
                    Mastering Python for Data Analysis: Top Tips and Tricks for Efficient Coding
                  </h4>
                </div>
              </a>
            </div>
            <div
              ...
              <a href="blog_details.php" class="blog-card">
                ...
                <div class="pt-4 pt-md-8 px-3 px-md-5">
                  ...
                  <h4 class="blog-title fs-five n5-color fw-semibold">
                    The Power of Predictive Analytics: Forecasting Future Trends with Machine Learning
                  </h4>
                </div>
              </a>
            </div>
            <div
              ...
              <a href="blog_details.php" class="blog-card">
                ...
                <div class="pt-4 pt-md-8 px-3 px-md-5">
                  ...
                  <h4 class="blog-title fs-five n5-color fw-semibold">
                    From Raw Data to Actionable Insights: A Step-by-Step Guide to Effective Data Visualization
                  </h4>
                </div>
              </a>
            </div>
